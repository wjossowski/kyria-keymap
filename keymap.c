...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT(
    ...
    MTC(LBR), KC_Z    , KC_X    , KC_C    , KC_V    , KC_B    , XXXXXXX , XXXXXXX ,                 XXXXXXX , XXXXXXX , KC_N    , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , MTC(KC_RBRC),
                                  KC_LPRN , KC_LALT , MTG(SPC), MTS(SPC), SPC_SYM ,                 MO(NUM) ,MTS(BSPC), KC_LALT , KC_LGUI , KC_RPRN
  ),
  ...
  [SYM] = LAYOUT(
    ...
    KC_LCBR , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , KC_BSLS , XXXXXXX , XXXXXXX ,                 XXXXXXX , XXXXXXX , KC_SLSH , KC_PIPE , KC_QUOT,  XXXXXXX , KC_BSLS , KC_RCBR ,
